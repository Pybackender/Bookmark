...
#         auth_user = get_user_by_token(request)
#         if auth_user and hasattr(auth_user, 'role'):
#             return auth_user.role.name == 'admin'
#         return False  # Explicitly return False if not authenticated or role is missing
...
#     def has_permission(self, request, view):
#         return get_user_by_token(request) is not None  # Explicit check for None
